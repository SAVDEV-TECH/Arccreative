...
function LoginForm() {
  return (
    ...
    <form className='w-[100%]  md:w-[45%]   ml-0   py-5 px-0  md:px-3 items-center justify-center gap-7 flex flex-col md:ml-[100px] '>
      <h1  className='text-2xl    w-[100%] md:w-[70%] font-bold text-left text-[0d0c22] font-sans'>Sign in to Arcreative</h1>
      <Link className='w-[100%]   sm:w-[70%] mx-auto flex items-center justify-center gap-3  md:w-[85%] px-11 text-[14px] text-center border border-gray-400 text-black font-semibold py-[17px] rounded-full bg-white'>
...
<path fill-rule="evenodd" clip-rule="evenodd" d="M8.99976 3.57955C10.3211 3.57955 11.5075 4.03364 12.4402 4.92545L15.0216 2.34409C13.4629 0.891818 11.4257 0 8.99976 0C5.48158 0 2.43794 2.01682 0.957031 4.95818L3.96385 7.29C4.67158 5.16273 6.65567 3.57955 8.99976 3.57955Z" fill="#EA4335"></path>
      ...
      <div className='flex w-[100%] md:w-[85%] mx-auto items-center gap-4 justify-center'>
      ...
      <div className='flex flex-col w-[90%] mx-auto gap-5 '>
       <div className='   w-full '>
        ...
        <input className='w-[100%]   shadow bg-gray-300 hover:shadow-pink-500 outline-none rounded-md py-[15px] block border border-gray-400' type='text'></input>
       </div>
       <span className=' block  '>
        ...
        <input className='w-[100%]  focus focus-within:shadow-pink-500 shadow hover:shadow-pink-500  outline-none rounded-md py-[17px]   bg-gray-300  border border-gray-400' type='text'></input>
        </div>
       </span>
      </div>
      <Link className='w-[90%]  sm:w-[70%] md:w-[85%] px-11 text-[14px]  text-center font-semibold text-gray py-[15px] rounded-full bg-blue-950 border text-white border-gray-400'> Sign in</Link>
